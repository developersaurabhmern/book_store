  ...
  const productList= useSelector(state => state.productList);
    ...
    const uploadFileHandler = async (e) => {
      ...
      try {
        ...
        fileToBase64(file, data).then(result => {
          $.ajax({
            url: "https://oldweb.bfcpublications.com/addBookStoreImg",
            type: "POST",
            data:{"bookName":name,"bookStoreId":"test", "bookPath":"test", "img":result},
...
// let sp=mrp*1+ee*1;
 ...
 setSp(sp);
  ...
  const submitHandler=(e)=>{
    ...
    dispatch(saveProduct({name, author_name, isbn, sku, fc, book_format, book_language, cat, mrp,discount, selling_price, book_size, page_number,  item_weight, dimension, brand, image, description, unit}));
   // notify();
                    ...
                    <div className="row">
                      <div className="col-4">
                        <div className="form-group">
                          ...
                          <input type="text" className="form-control" name="name" id="exampleInputEmail1" placeholder="Book Title" onChange={(e) => setName(e.target.value)} required/>
                        </div>
                      </div>
                      <div className="col-4">
                        <div className="form-group">
                          ...
                          <input type="text" className="form-control" onChange={(e) => setAuthorName(e.target.value)} name="author_name" id="exampleInputEmail1" placeholder=" Author Name" required/>
                        </div>
                      </div>
                      <div className="col-4">
                        <div className="form-group">
