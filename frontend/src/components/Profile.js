...
const myOrderGet = (e) => {
    ...
    var html = "";
    axios.post("/api/getmyorders", datab1, config3)
      .then(orders => {
        // this.setState({ totalOrders: orders.data })
        
	if(orders.data.length > 0){
        orders.data.map((item, index) => (
          html += "<div class='row order-books'><div class='col-2'><div class='image'><img src='"+item.orderItems[0].image+"' class='img-fluid' /></div></div><div class='col-4'><h6>"+item.orderItems[0].name+"</h6><p>QTY: "+item.orderItems[0].qty+"</p><p></p></div><div class='col-4'><h6>Total Price: "+item.totalPrice+"</h6></div></div>"
        
        ))
	}else{
          html += "<p class='order-not-found'>Order Not Found!</p>";
        }
        $("#myOrders").html(html)
              ...
              <div className="col-lg-3 col-md-3">
                ...
                <div className="sec1">
                  <div className="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a className="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false" onClick={myOrderGet}>My Order</a>
                      ...
                      <div className="row">
                        ...
                        <div className="col-12">
                          <div className="Userorder p-2">
                            ...
                            <div className="Orderinner" id="myOrders">
