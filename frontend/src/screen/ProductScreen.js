...
import { Facebook, Twitter,Whatsapp,Email,Instagram } from 'react-sharingbuttons'
import {
  EmailShareButton,
  EmailIcon,
  TwitterIcon,
...
.social_icons_rounded ul li a i {
  font-size: 16px
    ...
    font-family: cursive;
      ...
      <section className="main_section testrock">
                  ...
                  <img src={ product.image }/>
                      ...
                      <div className="col-md-7 col-12 list-wrapper" id="myList">
                        <div className="detail_right">
                          ...
                          <div className="social_icons_rounded">
   
<b style={{position: "relative",top:'-10px',

                            }}>Share</b>  
{/* <a href={'../../product/' + product._id} class="react-sharing-button__link react-sharing-button--twitter">
  <svg class="react-sharing-button__icon">...</svg>
  <span class="react-sharing-button__text"></span>
</a> */}



{/* <EmailShareButton url={'http://store.bfcpublications.com/product/' + product._id}
title={`${product.name}`}
className="m-2">
  <EmailIcon size={32} round={true}/>
  </EmailShareButton> */}
  
  <LinkedinShareButton url={'http://store.bfcpublications.com/product/' + product._id}
title={`${product.name}`}
...
className="m-2">
  <LinkedinIcon  size={32} round={true}/>
      ...
      <FacebookShareButton url={'http://store.bfcpublications.com/product/' + product._id}
      ...
      <TwitterShareButton url={'http://store.bfcpublications.com/product/' + product._id}
      ...
      <WhatsappShareButton
              url={"http://store.bfcpublications.com/product/"+ product._id}
              title={`${product.name}`}
              media={product.image}
              className="m-2">
                      ...
                      <span className="bg-danger out-stock">Book is Unavailable</span>
                        ...
                        <>ss</>
						  ...
						  {product.fc == "Upcoming Launches" ? (
                            ...
                            }}><h6 style={{backgroundColor:"#4bad37",  height:'40%',borderRadius: "10px",padding: "10px 0",color:'white'}}>coming soon</h6></span>
