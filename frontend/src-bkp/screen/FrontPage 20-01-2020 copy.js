...
function FrontPage(props){
  ...
  //pcheckAdult(products)
    ...
    console.log("fffffffnnnnnnnnnnnnnnnnnnnnnnn--",pxNR)
     ...
     <section className="home-slider">
        ...
        <MessageBox variant="danger">{error}</MessageBox>
               ...
               {pxNR.map((product) => (
                  ...
                  <div className="swiper-slide mmmmmmmmmmmmmmmm" style={{backgroundImage: `url(${'https://bfcpublications.com/public/frontendAssets/images/upcoming/heybharat.jpeg'})`, backgroundSize:`cover`, backgroundRepeat:`no-repeat`}}/>
