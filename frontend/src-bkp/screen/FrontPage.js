        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col mb-2 ss-heading">
              <h2>New Releases <span className="view_more_header"><a className="text-muted" href="Booklist?name=New Release">View More <i className="fa fa-arrow-right icon" /></a></span> </h2>
            </div>
          </div>
          <div className="row">
            <div className="col-md-12">
