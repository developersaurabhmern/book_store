...
// console.log("discount",discount)
  ...
  const submitHandler = (e) => {
    ...
    // return false;
    dispatch(saveProduct({ _id: id, name, author_name, isbn, sku, book_format, book_language, unit, mrp, discount, selling_price, book_size, page_number, item_weight, dimension, brand, image, description, fc, cat }));
  ...
  const columns = [
    ...
    },
    {
      ...
      selector: 'image',
      sortable: true,
      cell: row => <div ><img src={row.image} width="50" height="50"/></div>,
    ...
    
{
  ...
  sortable: true,
  cell: row => <div class="text-right py-0 align-middle">
               <div class="btn-group btn-group-sm">
                 <a href="#" class="btn btn-info" onClick={() => openModal(row)} data-toggle="modal" data-target="#view"><i class="fas fa-eye"></i></a>
                 <a href="#" class="btn btn-warning" onClick={() => openModal(row)} data-toggle="modal" data-target="#edit"><i class="fas fa-edit"></i></a>
                 <a href="#" onClick={() => deleteHandler(row)} class="btn btn-danger"><i class="fas fa-trash"></i></a>
               </div>
             </div>
},
                  ...
                  <div className="row">
                    ...
                    <div className="col-4">
                      <div className="form-group">
                        ...
                        <input type="text" className="form-control" onChange={(e) => fdiscount(e.target.value)} id="discount" value={discount} name="discount" placeholder="discount" />
                      </div>
                    </div>
                    <div className="col-4">
                      <div className="form-group">
                    ...
                    <div className="form-group">
                      ...
                      <select class="form-control" name="cat" value={cat} onChange={(e) => setCat(e.target.value)} required>
                        <option>Select Option</option>
                        {/* <option>Ebook</option> */}
