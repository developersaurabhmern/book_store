...
function AddBook(Props){
  ...
  const [selling_price, setSp]=useState('');
  ...
  const [image, setImage]=useState('https://notionpress.com/thumbs/phpThumb.php?src=../coveruploads/5fd34ddec823d-394679424.png&f=jpg&q=85&h=425&w=267&iar=1');
  const [description, setDesc]=useState('fffefef');
                  ...
                  <select class="form-control" name="cat"  onChange={(e) => setCat(e.target.value)}>
                      ...
                      <div className="col-4">
                        <div className="form-group">
                          ...
                          <input type="text" className="form-control" id="exampleInputPassword1" name="discount" placeholder="discount" />
                        </div>
                      </div>
                      ...
                      <div className="col-4">
                        <div className="form-group">
                          ...
                          <input type="text" className="form-control" id="exampleInputPassword1" name="selling_price" onChange={(e) => setSp(e.target.value)} placeholder="Selling Price" />
                        </div>
                      </div>
                      <div className="col-3">
                        <div className="form-group">
                        ...
                        <div className="form-group">
                          ...
                          <div className="input-group">
                            <div className="custom-file">
                              <input type="file" name="image" className="custom-file-input" id="exampleInputFile"/>
                      ...
                      <div className="col-md-12">
                        <div className="card-body pad">
                          <div className="mb-3">
                            ...
                            <textarea className="textarea" placeholder="Place some text here" name="description" style={{width: '100%', height: '200px', fontSize: '14px', lineHeight: '18px', padding: '10px'}}   onChange={(e) => setDesc(e.target.value)}/>
                          </div>
                        </div>
                      </div>
                    </div>
